# Generated by Django 2.1 on 2018-09-14 15:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_type', models.SmallIntegerField(choices=[(2, '脱产'), (0, '面授'), (1, '网络')], verbose_name='班级类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.SmallIntegerField(choices=[(3, '百度推广'), (0, '转介绍'), (1, 'QQ群'), (6, '市场推广'), (2, '官网'), (5, '知乎'), (4, '51CTO')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intention', models.SmallIntegerField(choices=[(3, '不报名'), (0, '两月内报名'), (2, '已报名'), (1, '一个月内报名')])),
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendance', models.SmallIntegerField(choices=[(1, '迟到'), (3, '早退'), (0, '已签到'), (2, '缺勤')], default=0)),
                ('score', models.SmallIntegerField(choices=[(50, 'B-'), (80, 'A-'), (90, 'A'), (100, 'A+'), (20, 'c-'), (-50, 'D'), (30, 'c'), (70, 'B+'), (40, 'c+'), (60, 'B')])),
